...
#define TFA9894N2_NAMETABLE static tfaBfName_t Tfa9894N2DatasheetNames[] = {\
	...
	{ 0x6102, "DELCURCOMP"},	/* Delay to align compensation signal with current sense signal, */\
...
#define TFA9894N2_BITNAMETABLE static tfaBfName_t Tfa9894N2BitNames[] = {\
	...
	{ 0x5e02, "rst_min_vbat_delay"},	/* Delay for resetting the min_vbat value inside HW Clipper (number of Fs pulses), */\
	...
	{ 0x6102, "cursense_comp_delay"},	/* Delay to align compensation signal with current sense signal, */\
