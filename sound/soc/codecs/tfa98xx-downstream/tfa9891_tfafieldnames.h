...
#define TFA9891_BITNAMETABLE static tfaBfName_t Tfa9891BitNames[] = {\
	...
	{ 0x660, "sel_other_vamp"},	/* Input selection for the second channel of the DCDC intelligent mode detector, */\
	...
	{ 0x4840, "ctrl_coincidencebst"},	/* Switch protection on to prevent simultaneously switching power stages bst and amp, */\
	...
	{ 0x49f0, "setse"},	/* switches between Single End and differentail mode, */\
	...
	{ 0x50e1, "ctrl_test_mono"},	/* ABIST mode to add both amplifier halves as stereo or one amplifier half as mono, */\
	...
	{ 0x550e, "enbl_amp"},	/* enbl_amp for testing to enable all analogue blocks in amplifier, */\
	...
	{ 0x5637, "enbl_ref"},	/* for testing to enable all analogue blocks in references, */\
