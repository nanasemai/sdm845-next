...
#define IMX355_REG_EXCK_FREQ		0x0136
...
struct imx355_clk_params {
	u32 ext_clk;
	u16 exck_freq;	/* EXCK_FREQ register (MHz in 8.8 fixed point) */
...
static int imx355_start_streaming(struct imx355 *imx355)
{
	...
	ret = imx355_write_reg(imx355, IMX355_REG_EXCK_FREQ, 2,
			       imx355->clk_params->exck_freq);
	if (ret)
		return ret;
